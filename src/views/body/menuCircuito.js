...
function generarMenuCircuito(){
    if(!localStorage.getItem('access_token')){
        ...
        <div class="flex-row">
        <a><div id="menu-circuitos-circuito" class="menu-circuitos"><h2>Conoce toda la informacion sobre los 24 gran premios de esta temporada </h2></div></a>
        <a><div id="menu-circuitos-stats" class="menu-circuitos"><h2>Conoce los 20 pilotos de F1 y las 10 escuderias que competiran por ganar</h2> </div></div></a>
      </div>`;
